  ...
  <div>
    ...
    >
      ...
      <div class="flex mt-3">
        <!-- 支付宝支付 -->
        <div
          class="flex items-center pl-2 cursor-pointer border border-zinc-200 dark:border-zinc-600 rounded-sm w-[220px] h-[60px] duration-200 hover:bg-zinc-50 hover:dark:bg-zinc-800"
        >
